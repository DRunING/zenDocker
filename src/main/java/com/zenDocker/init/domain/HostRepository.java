...
/*Dao只要继承JpaRepository类就可以，几乎可以不用写方法，还有一个特别有尿性的功能非常赞，就是可以根据方法名来自动的生产SQL，比如findByUserName
...
public interface HostRepository extends JpaRepository<Host, Long>{
    ...
    Host findByIpAddressOrCreateTime(String ipAddress, String createTime);
}
